		...
		<view class="index-goods" v-if="loadGoods">
			...
			<view class="goods_info" style="padding-top: 6px">
				<view style="padding: 8px">
					<image v-if="goods.shoptype == 'B'" style="height: 14px;width:12px;margin-top: 4px;margin-right: 4px" src="../../static/img/mao.png"></image>
					<image v-else style="height: 14px;width:12px;margin-top: 4px;margin-right: 4px" src="../../static/img/taobao.png"></image>

					<text style="font-weight: bold">
						<text v-if="goods.shopname" style="color: #e10a07;font-weight: bold">【{{ goods.shopname }}】</text>
						{{ goods.itemtitle }}
					</text>
				</view>
			...
			<view class="goods_shop_cart">
				<view class="cent" style="display: flex">
					...
					<view style="width: 75%;display: flex;color: white">
						<!-- #ifdef MP-WEIXIN -->
						<button open-type="share" style="width: 300upx;line-height: 90upx;color: #FFFFFF;background:#e10a07; ">分享给好友</button>
