<template>
	<view class="s-page-wrapper">
		<view class="index-goods" v-if="goods&&goods.imageInfo">
			...
			<view class="goods_reco" style="text-align: center;font-size: 36upx;color: #333333;background: white;margin-top:6upx;padding: 10upx;"  v-if="goods.imageInfo.imageList">
				<view class="imglist" >
			...
			loadGoodsInfo: function() {
				...
				this.$Request.getT('/jd/goods/' + this.itemid).then(res => {
					if (res.code === 200) {
						...
						item.couponmoney=item.couponInfo.couponList[0].discount
