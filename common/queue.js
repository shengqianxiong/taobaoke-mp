...
module.exports = {
	...
	invitaionNum() {
		return uni.getStorageSync("invitaionNum") ? uni.getStorageSync("invitaionNum") : '20'
	},
	maxMoney() {
		return uni.getStorageSync("maxMoney") ? uni.getStorageSync("maxMoney") : '0.7'
	},
	teamMoney() {
		return uni.getStorageSync("teamMoney") ? uni.getStorageSync("teamMoney") : '0.2'
	},
	logout() {
		this.remove("token");
		this.remove("userId");
	...
	getSearchKeys: function(key) {
		let list = "淘宝,天猫，套套，情趣用品，避孕，男用，女用，成人用品，保健品，冈本 杜蕾斯 杰士邦 第六感 倍力乐 诺丝 多乐士 斯香妮 双一 雨蝶 玛尼仕，充气娃娃，娃娃充气 阴蒂 刺激 超薄 螺纹 震动 润滑 女液体 延时 ";
