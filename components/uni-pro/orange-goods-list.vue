<template>
	...
	<view class="coupon-page s-row" @tap="open(itemid)" v-bind:key='itemid' style="margin:16upx 16upx 8upx 16upx;background: white;border-radius: 32upx;padding: 8upx;">
		<view class="image">
		...
		<view class="content">
			<view style="display: flex">
				<text class="twolist-hidden" style="height: 80upx;font-size: 28upx;margin-right: 4upx;margin-left: 4upx;width: 95%;max-lines:2;overflow: hidden">
					<text v-if="isEnable != '否'" style="color: #FFFFFF;background: #E10A07;font-size: 24upx;padding-left: 12upx;padding-right: 12upx;border-radius: 6upx;margin-right: 8upx;padding-top: 4upx;padding-bottom: 4upx;">天猫</text>
					<text v-if="isEnable == '否'" style="color: #FFFFFF;background: #E10A07;font-size: 24upx;padding-left: 12upx;padding-right: 12upx;border-radius: 6upx;margin-right: 8upx;padding-top: 4upx;padding-bottom: 4upx;">京东</text>
			...
			<view class="num s-row" style="font-size: 24upx;margin-top: -6px;margin-right: 32upx;" v-else>
